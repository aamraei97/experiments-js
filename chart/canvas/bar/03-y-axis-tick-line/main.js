...
class Chart {
    ...
    #drawYAxisTicks() {
        ...
        while (currentYTick <= AVAILABEL_Y_HEIGHT) {
            ...
            this.ctx.beginPath();
            // Y axis line should start after the Y Axis Ticks Width
            this.ctx.moveTo(this.#bar_options.axis.y.width - 4, -(currentYTick + BAR_CHART_BOTTOM_SPACE - ANTI_ALIASING_VALUE));
            this.ctx.lineTo(this.#bar_options.axis.y.width, -(currentYTick + BAR_CHART_BOTTOM_SPACE - ANTI_ALIASING_VALUE))
            this.ctx.stroke(); // 
